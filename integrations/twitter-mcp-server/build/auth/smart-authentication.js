...
import { TwitterMcpError, isCookieAuth, isCredentialsAuth, } from '../types.js';
    ...
    async authenticate(config) {
        ...
        if (config && isCredentialsAuth(config)) {
            ...
            try {
                ...
                throw new TwitterMcpError(`Credential authentication failed: ${error.message}`, 'auth_failure');
            }
        }
        ...
        if (config && isCookieAuth(config)) {
            ...
            try {
                ...
                throw new TwitterMcpError(`Cookie authentication failed: ${error.message}`, 'auth_failure');
            }
        }
        ...
        throw new TwitterMcpError('All authentication methods failed. Please provide valid credentials or cookies.', 'auth_failure');
    }
    /**
...
//# sourceMappingURL=smart-authentication.js.map