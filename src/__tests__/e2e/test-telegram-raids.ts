...
console.log(
  "   - Actions:",
  enhancedTelegramRaidsPlugin.actions?.map((a) => a.name),
);
console.log(
  "   - Providers:",
  enhancedTelegramRaidsPlugin.providers?.map((p) => p.name),
);
console.log(
  "   - Services:",
  enhancedTelegramRaidsPlugin.services?.map(
    (s) => s.name || s.constructor.name,
  ),
);
...
const hasRaidsService = nubiPlugin.services?.some(
  (service) =>
    service === EnhancedTelegramRaidsService ||
...
try {
  ...
  console.log(
    "   - Has start method:",
    typeof (service as any).start === "function",
  );
  console.log(
    "   - Has joinRaid method:",
    typeof (service as any).joinRaid === "function",
  );
  console.log(
    "   - Has getRaidStats method:",
    typeof (service as any).getRaidStats === "function",
  );
} catch (error) {
...
console.log(
  "   - Telegram plugin in character.plugins:",
  process.env.TELEGRAM_BOT_TOKEN ? "✅ Will be loaded" : "❌ Missing token",
);
console.log(
  "   - EnhancedTelegramRaidsService in nubi-plugin.services:",
  hasRaidsService ? "✅" : "❌",
);
console.log(
...
console.log(
  "   - startRaidSession:",
  typeof (raidService as any).startRaidSession === "function" ? "✅" : "❌",
);
console.log(
  "   - joinRaid:",
  typeof (raidService as any).joinRaid === "function" ? "✅" : "❌",
);
console.log(
  "   - getRaidStats:",
  typeof (raidService as any).getRaidStats === "function" ? "✅" : "❌",
);
console.log(
  "   - endRaidSession:",
  typeof (raidService as any).endRaidSession === "function" ? "✅" : "❌",
);
console.log(
  "   - getActiveRaids:",
  typeof (raidService as any).getActiveRaids === "function" ? "✅" : "❌",
);
...
if (passed === checks.length) {
  ...
  if (!hasRaidsService) {
    console.log(
      "      - Add EnhancedTelegramRaidsService to nubi-plugin services",
    );
  }
}
