    ...
    async run() {
        ...
        const testSuites = [
            ...
            },
            {
                ...
                path: 'src/__tests__/raids-integration.test.ts',
                description: 'Service and event integration'
            },
            {
                name: 'Webhook Tests',
                path: 'src/__tests__/webhook.test.ts',
                description: 'Webhook endpoint testing'
            },
            {
                name: 'MCP Tests',
                path: 'src/__tests__/mcp-integration.test.ts',
                description: 'MCP/xmcp tool testing'
            }
        ];
